...
function Fetchdata()
{
    fetch("https://add-to-cart-backend-gwkn.onrender.com/pitches")
    .then((res)=>res.json())
    .then((data)=>{
      CardList(data)
      productData=data
...
function SingleCard(id,image,title,founder,category,price)
{
 ...
 {
  fetch(`https://add-to-cart-backend-gwkn.onrender.com/pitches/${id}`,{
    method:'DELETE'
  })
  .then((res)=>res.json)
  .then((data)=>{
...
function populateData(id)
{
 ...
 updatePitchBtn.addEventListener("click",()=>{
  ...
  fetch(`https://add-to-cart-backend-gwkn.onrender.com/pitches/${updateData.id}`,{
    method:'PUT',
    headers:{
      'Content-Type': 'application/json',
    },
...
updatePricePitchPriceButton.addEventListener("click",()=>{
  ...
  fetch(`https://add-to-cart-backend-gwkn.onrender.com/pitches/${UpdatePriceData.id}`,{
      method:"PUT",
      headers:{
          "Content-Type": "application/json",
      },
